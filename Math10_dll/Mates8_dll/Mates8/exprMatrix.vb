...
sigI:
    ...
    Public Function OpMax() As Double
        ...
        Try
            Dim Ma As Matrix = Me.getMatrix
            For i As Int32 = 0 To Ma.vVect.Length - 1
                For j As Int32 = 0 To Ma.vVect(i).vPoly.Length - 1
                    Dim Pa As Polynomial = Ma.vVect(i).vPoly(j)
                    If Pa.isReal Then
                        Dim cur As Double = Pa.ToDouble
                        If cur > max Then
                            max = cur
                        End If
                    Else
