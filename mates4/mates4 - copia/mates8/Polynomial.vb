        ...
        If bVerify Then
            Try
                If polyC.PolyResto Is Nothing Then
                    Dim polyD As Polynomial = polyC * polyB - polyA
                ...
                ElseIf polyA.PolyResto IsNot Nothing AndAlso polyB.PolyResto IsNot Nothing Then
                    ...
                    Dim a As New Polynomial(polyA)
                    a.PolyResto = Nothing
                    Dim na As New Polynomial(polyA.PolyResto)
                    Dim da As New Polynomial(polyA.PolyDivisor)
                    Dim b As New Polynomial(polyB)
                    b.PolyResto = Nothing
                    Dim n2 As New Polynomial(polyC.PolyResto)
                    Dim d2 As New Polynomial(polyC.PolyDivisor)
                    Dim c As New Polynomial(polyC)
                    c.PolyResto = Nothing
                    Dim n As New Polynomial(polyC.PolyResto)
                    Dim d As New Polynomial(polyC.PolyDivisor)
                    Dim polyD As Polynomial = mult(b, c) - a
                    If polyD.isComplex = False OrElse polyD.cf(0).esCero = False Then
                        Stop
                    End If
                ...
                ElseIf polyA.PolyResto IsNot Nothing Then
                    ...
                    End If
                Else
                    Dim polyD As New Polynomial(polyC)
                    ...
                    If polyD.isComplex = True AndAlso polyD.cf(0).esCero Then
                        ...
                        Dim b As New Polynomial(polyB)
                        b.PolyResto = Nothing
                        Dim n2 As New Polynomial(polyB.PolyResto)
                        Dim d2 As New Polynomial(polyB.PolyDivisor)
                        Dim c As New Polynomial(polyC)
                        c.PolyResto = Nothing
                        Dim n As New Polynomial(polyC.PolyResto)
                        Dim d As New Polynomial(polyC.PolyDivisor)
