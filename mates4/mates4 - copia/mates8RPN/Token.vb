Public Class Token
    ...
    Friend pos As Int32
    Friend iToken As Int32
    Friend dblVal As ExprMatrix
    Friend eP As exprParser84
    Friend sTkn As String
    'Friend Poly As Polynomial84
    Friend Sub New(tipo As tokenType84, subTipo As Int32, eMtx As ExprMatrix, pos As Int32, iToken As Int32, strTkn As String)
        Me.tipo = tipo
        Me.subTipo = subTipo
    ...
    Public Shared Function op(sOp As Char, ATkn As Token, BTkn As Token) As Token
        ...
        Try
            Dim i As Int32 = CTkn.tipo + BTkn.tipo * 4
            'oprnd = 0 (num)
            Select Case sOp
                Case "+"
    ...
    Public Shared Function opMultDetail(ATkn As Token, BTkn As Token) As String
        ...
        Try
            ...
            For i As Int32 = 0 To vTermsA.Length - 1
                For j As Int32 = 0 To vTermsB.Length - 1
                    Dim scur As String =
        ...
        Try
            If cfg.bRounding Then
                ...
                If eM.Rows = 1 AndAlso eM.Cols = 1 AndAlso eM.getExpr(0, 0).IsPolynomial Then
                    ...
                    For i As Int32 = 0 To pa.cf.Length - 1
    ...
    Public Overrides Function ToString() As String
        Return dblVal.ToString()
    End Function
    Friend Function ToStringStackTkn(
        ...
        Try
            ...
            If tipo = tokenType84.oprnd Then
                Return dblVal.ToString() ' exprMatrix
